      ...
      <div className="grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-[32px] bg-white shadow-2xl md:grid-cols-[1.2fr_1fr]">
        <div className="relative overflow-hidden bg-slate-200 p-6 md:p-10">
          ...
          <div className="absolute left-6 top-6 rounded-3xl border border-white/70 bg-white/80 p-4 shadow-lg backdrop-blur-sm">
            <h2 className="text-2xl font-bold text-slate-900">Join Movie Database</h2>
            <p className="mt-2 max-w-xs text-sm text-slate-600">
              Create an account to save your watchlist, add reviews, and access your movie dashboard.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center p-8 md:p-10">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-600">Register now and get access to the full movie dashboard experience.</p>
          </div>
          ...
          <p className="mt-6 text-sm text-slate-600">
            ...
            <button type="button" onClick={onSwitchToLogin} className="font-semibold text-sky-600 hover:text-sky-700">
              Login Here
            </button>
          </p>
        </div>
